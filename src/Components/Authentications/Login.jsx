  ...
  return (
    <div className="relative flex flex-col justify-center min-h-screen overflow-hidden">
      <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl lg:max-w-xl">
        <h1 className="text-3xl font-semibold text-center text-[#FF3811] uppercase">
          Sign in
        </h1>
        <form onSubmit={handleLogin} className="mt-6">
          ...
          <div className="mt-6">
            <button
              type="submit"
              className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-[#FF3811] rounded-md hover:bg-[#ff3b3b] focus:outline-none"
            >
              Login
            </button>
          </div>
